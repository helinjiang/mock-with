...
var DataMockController = function () {
    ...
    _createClass(DataMockController, [{
        key: 'addList',
        ...
        value: function getRandom() {
            ...
            while (true) {
                // 首先生成随机一个数
                var randomIndex = (0, _tools.getRandomIndex)(this.store);
        ...
        key: 'getDataByTag',
        value: function getDataByTag(tags, isStrict) {
            ...
            return (0, _tools.getOneOf)(filterResult).getData();
        }
    }]);
